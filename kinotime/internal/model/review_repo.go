...
func (repo *ReviewRepository) GetReviewByID(ctx context.Context, id int) (*types.Review, error) {
...
func (repo *ReviewRepository) GetReviewsByMovieID(ctx context.Context, movieID int) ([]types.Review, error) {
