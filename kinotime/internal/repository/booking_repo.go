...
func (repo *BookingRepository) GetBookingsByUserID(ctx context.Context, userID int) ([]models.Booking, error) {
...
func (repo *BookingRepository) GetAllBookings(ctx context.Context) ([]models.Booking, error) {
